...
CREATE TABLE foto (
    id_foto                NUMBER(32) NOT NULL,
    jmeno_souboru          VARCHAR2(50) NOT NULL,
    data                   BLOB NOT NULL,
    datum_pridani          DATE NOT NULL,
    karta_mhd_id_karty     NUMBER(32) NOT NULL,
    uzivatele_id_uzivatele NUMBER(32) NOT NULL
);
...
CREATE TABLE jizdy (
    id_jizdy           NUMBER(32) NOT NULL,
    zacatek            DATE NOT NULL,
    konec              DATE,
    vozidlo_id_vozidla NUMBER(32) NOT NULL,
    linka_id_linky     NUMBER(32) NOT NULL
);

ALTER TABLE jizdy ADD CONSTRAINT jizda_pk PRIMARY KEY ( id_jizdy );

CREATE TABLE jizdy_ridicu (
    ridic_id_ridice NUMBER(32) NOT NULL,
    jizda_id_jizdy  NUMBER(32) NOT NULL
);

ALTER TABLE jizdy_ridicu ADD CONSTRAINT relation_10_pk PRIMARY KEY ( ridic_id_ridice,
                                                                     jizda_id_jizdy );

CREATE TABLE karty_mhd (
    id_karty              NUMBER(32) NOT NULL,
    zustatek              NUMBER(10, 2) NOT NULL,
    platnost_od           DATE NOT NULL,
    platnost_do           DATE NOT NULL,
    zakaznik_id_zakaznika NUMBER(32) NOT NULL,
    foto_id_foto          NUMBER(32) NOT NULL
);
...
CREATE TABLE predplatne (
    id_predplatneho           NUMBER(32) NOT NULL,
    od                        DATE NOT NULL,
    do                        DATE NOT NULL,
    karta_mhd_id_karty        NUMBER(32) NOT NULL,
    typ_p_id_typ_predplatneho NUMBER(32) NOT NULL
);

ALTER TABLE predplatne ADD CONSTRAINT predplatne_pk PRIMARY KEY ( id_predplatneho );

CREATE TABLE ridici (
    id_ridice NUMBER(32) NOT NULL,
...
CREATE TABLE typy_predplatneho (
    id_typ_predplatneho NUMBER(32) NOT NULL,
...
CREATE TABLE typy_uzivatele (
    id_typ_uzivatele NUMBER(32) NOT NULL,
...
CREATE TABLE typy_vozidel (
    id_typ_vozidla NUMBER(32) NOT NULL,
...
CREATE TABLE uzivatele (
    id_uzivatele                   NUMBER(32) NOT NULL,
    ...
    typ_uzivatele_id_typ_uzivatele NUMBER(32) NOT NULL,
    adresa_id_adresy               NUMBER(32) NOT NULL
);
...
CREATE TABLE vozidla (
    id_vozidla                 NUMBER(32) NOT NULL,
    typ_vozidla_id_typ_vozidla NUMBER(32) NOT NULL
);

ALTER TABLE vozidla ADD CONSTRAINT vozidlo_pk PRIMARY KEY ( id_vozidla );

CREATE TABLE zakaznici (
    id_zakaznika          NUMBER(32) NOT NULL,
    uzivatel_id_uzivatele NUMBER(32) NOT NULL
);
...
CREATE TABLE zamestnanci (
    id_zamestnance             NUMBER(32) NOT NULL,
    plat                       NUMBER(6),
    platnost_uvazku_do         DATE,
    zamestnanec_id_zamestnance NUMBER(32) NOT NULL,
    uzivatel_id_uzivatele      NUMBER(32) NOT NULL
);
...
ALTER TABLE foto
    ADD CONSTRAINT foto_karta_mhd_fk FOREIGN KEY ( karta_mhd_id_karty )
        REFERENCES karty_mhd ( id_karty );

ALTER TABLE foto
    ADD CONSTRAINT foto_uzivatele_fk FOREIGN KEY ( uzivatele_id_uzivatele )
        REFERENCES uzivatele ( id_uzivatele );

ALTER TABLE jizdy
    ADD CONSTRAINT jizda_linka_fk FOREIGN KEY ( linka_id_linky )
        REFERENCES linky ( id_linky );

ALTER TABLE jizdy
    ADD CONSTRAINT jizda_vozidlo_fk FOREIGN KEY ( vozidlo_id_vozidla )
        REFERENCES vozidla ( id_vozidla );

ALTER TABLE jizdy_ridicu
    ADD CONSTRAINT jizdy_ridicu_jizda_fk FOREIGN KEY ( jizda_id_jizdy )
        REFERENCES jizdy ( id_jizdy );

ALTER TABLE jizdy_ridicu
    ADD CONSTRAINT jizdy_ridicu_ridic_fk FOREIGN KEY ( ridic_id_ridice )
        REFERENCES ridici ( id_ridice );

ALTER TABLE karty_mhd
    ADD CONSTRAINT karta_mhd_foto_fk FOREIGN KEY ( foto_id_foto )
        REFERENCES foto ( id_foto );

ALTER TABLE karty_mhd
    ADD CONSTRAINT karta_mhd_zakaznik_fk FOREIGN KEY ( zakaznik_id_zakaznika )
        REFERENCES zakaznici ( id_zakaznika );

ALTER TABLE platby
    ADD CONSTRAINT platba_zakaznik_fk FOREIGN KEY ( zakaznik_id_zakaznika )
        REFERENCES zakaznici ( id_zakaznika );

ALTER TABLE predplatne
    ADD CONSTRAINT predplatne_karta_mhd_fk FOREIGN KEY ( karta_mhd_id_karty )
        REFERENCES karty_mhd ( id_karty );

ALTER TABLE predplatne
    ADD CONSTRAINT predplatne_typ_predplatneho_fk FOREIGN KEY ( typ_p_id_typ_predplatneho )
        REFERENCES typy_predplatneho ( id_typ_predplatneho );

ALTER TABLE uzivatele
    ADD CONSTRAINT uzivatel_adresa_fk FOREIGN KEY ( adresa_id_adresy )
        REFERENCES adresy ( id_adresy );

ALTER TABLE uzivatele
    ADD CONSTRAINT uzivatel_typ_uzivatele_fk FOREIGN KEY ( typ_uzivatele_id_typ_uzivatele )
        REFERENCES typy_uzivatele ( id_typ_uzivatele );

ALTER TABLE vozidla
    ADD CONSTRAINT vozidlo_typ_vozidla_fk FOREIGN KEY ( typ_vozidla_id_typ_vozidla )
        REFERENCES typy_vozidel ( id_typ_vozidla );

ALTER TABLE zakaznici
    ADD CONSTRAINT zakaznik_uzivatel_fk FOREIGN KEY ( uzivatel_id_uzivatele )
        REFERENCES uzivatele ( id_uzivatele );

ALTER TABLE zamestnanci
    ADD CONSTRAINT zamestnanec_uzivatel_fk FOREIGN KEY ( uzivatel_id_uzivatele )
        REFERENCES uzivatele ( id_uzivatele );

ALTER TABLE zamestnanci
    ADD CONSTRAINT zamestnanec_zamestnanec_fk FOREIGN KEY ( zamestnanec_id_zamestnance )
        REFERENCES zamestnanci ( id_zamestnance );

ALTER TABLE zastaveni
    ADD CONSTRAINT zastaveni_linka_fk FOREIGN KEY ( linka_id_linky )
        REFERENCES linky ( id_linky );

ALTER TABLE zastaveni
    ADD CONSTRAINT zastaveni_zastavka_fk FOREIGN KEY ( zastavka_id_zastavky )
